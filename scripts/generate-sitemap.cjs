...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  // Add static pages (sections on homepage)
  sitemap += '\n\n  <!-- Homepage Sections -->';
  const staticPages = [
    { path: '/#membership', priority: 0.7 }, // Anchor section on homepage
    { path: '/#contact', priority: 0.7 }, // Anchor section on homepage
    { path: '/#about', priority: 0.6 }, // Anchor section on homepage
  ];
