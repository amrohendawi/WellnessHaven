  ...
  return (
    <footer className="relative bg-black text-white pt-16 pb-8 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className={`flex flex-col ${dir === 'rtl' ? 'md:flex-row-reverse' : 'md:flex-row'} justify-between max-w-6xl mx-auto`}>
          ...
          <div className={`grid grid-cols-1 sm:grid-cols-3 gap-10 md:w-2/3 ${dir === 'rtl' ? 'md:pl-0 md:pr-16' : 'md:pl-16 md:pr-0'}`}>
            <div>
              <h4 className="text-lg font-display font-medium mb-5 text-gold">{t('quickLinks')}</h4>
              <ul className="space-y-3">
                <li><a href="#home" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('menuHome')}</a></li>
                <li><a href="#services" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('menuServices')}</a></li>
                <li><a href="#membership" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('menuMembership')}</a></li>
                <li><a href="#about" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('aboutUs')}</a></li>
                <li><a href="#contact" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('menuContact')}</a></li>
              </ul>
            </div>
            
            <div>
              <h4 className="text-lg font-display font-medium mb-5 text-gold">{t('menuServices')}</h4>
              <ul className="space-y-3">
                <li><Link href="/services/laser-hair-removal" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('laserHairRemoval')}</Link></li>
                <li><Link href="/services/skin-tightening" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('skinTightening')}</Link></li>
                <li><Link href="/services/facial-treatments" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('facialTreatments')}</Link></li>
                <li><Link href="/services/hair-services" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('hairServices')}</Link></li>
                <li><Link href="/services" className="text-gray-300 hover:text-gold transition-colors inline-block">{t('viewAll')}</Link></li>
              </ul>
            </div>
            
            <div>
              <h4 className="text-lg font-display font-medium mb-5 text-gold">{t('menuContact')}</h4>
        ...
        <div className={`flex flex-col ${dir === 'rtl' ? 'md:flex-row-reverse' : 'md:flex-row'} justify-between items-center text-center md:text-left`}>
          ...
          <div className={`flex items-center mt-4 md:mt-0 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
            <div className={`text-sm text-gold/80 px-4 py-2 border border-gold/20 rounded-full ${dir === 'ltr' ? 'mr-4' : 'ml-4'}`}>
