        ...
        <div className={`flex flex-col ${dir === 'rtl' ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-12`}>
          ...
          <div className="md:w-1/2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
              <div className={`flex items-center ${dir === 'rtl' ? 'flex-row-reverse' : ''} p-4 rounded-lg gold-shadow border border-gold/20 bg-white`}>
                <div className={`w-14 h-14 rounded-full bg-gold-light/30 flex items-center justify-center ${dir === 'ltr' ? 'mr-4' : 'ml-4'}`}>
              ...
              <div className={`flex items-center ${dir === 'rtl' ? 'flex-row-reverse' : ''} p-4 rounded-lg gold-shadow border border-gold/20 bg-white md:col-span-2`}>
                <div className={`w-14 h-14 rounded-full bg-gold-light/30 flex items-center justify-center ${dir === 'ltr' ? 'mr-4' : 'ml-4'}`}>
