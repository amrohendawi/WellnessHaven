    ...
    <section id="membership" className="py-16 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="royal-heading text-3xl md:text-4xl mb-8">{t('membershipTitle')}</h2>
          <div className="fancy-divider mb-4">
            <i className="fas fa-crown fancy-divider-icon text-gold mx-2"></i>
          </div>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">{t('membershipSubtitle')}</p>
        </div>
            ...
            <div className="bg-gradient-to-br from-[#f7df8e] to-[#d4af37] text-black-gold rounded-2xl p-6 md:p-8 h-full backdrop-blur-sm">
              ...
              <div className="bg-black/5 backdrop-blur-sm border border-gold-dark/20 rounded-xl p-5 mb-8">
                <div className="flex flex-col text-gold-dark">
                  ...
                  <span className="text-base font-normal text-black-gold opacity-80 mt-2">
                    {t('goldCost')}
                  </span>
                </div>
              </div>
              ...
              <div className="mb-8">
                <div
                  className={`flex items-start mb-4 ${dir === 'rtl' ? 'flex-row-reverse text-right' : ''}`}
                >
                  <div
                    className={`${dir === 'rtl' ? 'ml-3' : 'mr-3'} mt-1 bg-gold rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0`}
                  >
            ...
            <div className="bg-gradient-to-br from-[#f5f5f5] to-[#e6e6e6] text-gray-800 rounded-2xl p-6 md:p-8 h-full backdrop-blur-sm">
              ...
              <div className="bg-black/5 backdrop-blur-sm border border-gray-400/20 rounded-xl p-5 mb-8">
                <div className="flex flex-col text-gray-700">
                  ...
                  <span className="text-base font-normal text-gray-600 opacity-80 mt-2">
                    {t('silverCost')}
                  </span>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                >
                  <div
                    className={`${dir === 'rtl' ? 'ml-3' : 'mr-3'} mt-1 bg-gray-500 rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0`}
                  >
                    <i className="fas fa-check text-white text-xs"></i>
                  </div>
