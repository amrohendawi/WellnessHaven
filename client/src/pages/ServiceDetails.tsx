    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <div 
          ...
          style={{
            backgroundImage: (service?.imageLarge || service?.imageUrl) && typeof (service?.imageLarge || service?.imageUrl) === 'string' ? 
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-lg max-w-2xl shadow-lg border border-gray-100">
              <h1 className="font-display text-3xl md:text-4xl font-bold mb-2 text-gray-800">
                {service?.name ? (service.name[language as keyof typeof service.name] || service.name.en) : t('loading')}
              </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="mt-8">
                ...
                <div className="bg-beige-light p-5 rounded-lg border border-gold/20 shadow-md">
                  <div className="flex justify-between mb-3">
                    ...
                    <span className="text-right">{service?.duration || 0} {t('minutes')}</span>
                  </div>
                  <div className="flex justify-between mb-3">
            ...
            <div>
              <div className="bg-white shadow-xl rounded-lg p-6 border border-pink/10 sticky top-24 gold-shadow">
                <h3 className="text-xl font-semibold mb-4 text-center text-pink-dark pb-2 border-b border-gold/20">{t('bookThisService')}</h3>
                ...
                <button
                  ...
                  onClick={() => window.location.href = "https://wa.me/971501234567?text=Hello,%20I'm%20interested%20in%20your%20" + (service?.name?.en || 'spa') + "%20service"}
                >
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  ...
                  <ul className="space-y-2.5">
                    {relatedServices.length > 0 ? relatedServices.map(s => (
                        ...
                        <li className="text-sm text-gray-500 italic">No related services available</li>
                      )}
                  </ul>
                </div>
              </div>
