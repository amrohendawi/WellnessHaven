    ...
    <div className="container max-w-3xl mx-auto py-8 px-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This page tests the API connectivity in your current environment to help diagnose deployment issues.
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4">
            <div className="grid gap-2">
              ...
              <ul className="list-disc pl-5 text-sm">
                ...
                <li>Current Host: {typeof window !== 'undefined' ? window.location.host : 'N/A'}</li>
